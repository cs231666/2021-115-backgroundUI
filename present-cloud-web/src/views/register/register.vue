    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-row type="flex" class="row-bg" justify="end">
        ...
        <el-col :span="6"><div class="grid-content bg-purple">
          <el-link type="primary"  style="margin-bottom: 10px;font-size: 15px" :underline="false">忘记密码？
          </el-link>
        </div>
        </el-col>
      </el-row>
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:20px;" @click.native.prevent="handleLogin">登录</el-button>
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:10px;margin-left: 0px;">注册到云账号</el-button>
